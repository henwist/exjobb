...
class BMP280(object):
    ...
    def _load_calibration(self):
        reg_val=self.cal_t1 = int(self._device.readU16(BMP280_DIG_T1))  # UINT16
	print "reg_val << 8 : ", reg_val
	reg_val=self.cal_t2 = int(self._device.readS16(BMP280_DIG_T2))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_t3 = int(self._device.readS16(BMP280_DIG_T3))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p1 = int(self._device.readU16(BMP280_DIG_P1))  # UINT16
	print "reg_val << 8 : ", reg_val	
        reg_val=self.cal_p2 = int(self._device.readS16(BMP280_DIG_P2))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p3 = int(self._device.readS16(BMP280_DIG_P3))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p4 = int(self._device.readS16(BMP280_DIG_P4))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p5 = int(self._device.readS16(BMP280_DIG_P5))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p6 = int(self._device.readS16(BMP280_DIG_P6))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p7 = int(self._device.readS16(BMP280_DIG_P7))  # INT16
	print "reg_val << 8 : ", reg_val
        reg_val=self.cal_p8 = int(self._device.readS16(BMP280_DIG_P8))  # INT16
	print "reg_val << 8 : ", reg_val	
	reg_val=self.cal_p9 = int(self._device.readS16(BMP280_DIG_P9))  # INT16
	print "reg_val << 8 : ", reg_val
